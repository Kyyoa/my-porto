...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || "https://github.com/Kyyoa",
      };
  ...
  return (
    <>
      <Helmet>
        <title>{project.Title} — Rzky Yovi Attala</title>
        <meta
          name="description"
          content={
            project.Description
              ? project.Description.slice(0, 155)
              : `Project ${project.Title} oleh Rzky Yovi Attala — Full-Stack Architect, AI-Driven Execution.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.Title} — Rzky Yovi Attala`}
        />
        <meta
